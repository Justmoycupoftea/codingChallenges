...
//parameters: an array of positive integers, whole nums greater than 0, the array has a min of 4 integers

//results: the sum of the 2 lowest ints in the array, a num
...
//pseudocode: sort the array from smallest to largest, capture the two smallest array members, and return their sum
...
function sumTwoSmallestNumbers(numbers) {  
    ...
    numbers.splice(numbers.indexOf(firstNum), 1) //we are splicing from lowests num
